...
*/
Drupal.theme.prototype.CToolsMyModalTheme = function () {
  var html = '';

  html += '<div id="ctools-modal" class="popups-box">';
  html += '  <div class="ctools-modal-content ctools-sample-modal-content '+ Drupal.CTools.Modal.currentSettings.modalmyclass +'">';
